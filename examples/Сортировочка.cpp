...
свет_мой_зеркальце<скажи Т> бестолочь пузырь(Т *полк, целина поголовье)
{
...
{
	вперёд_славяне;
	молвить << "Начало работы" тѣчи;
	приказ_княжий целина размер = 100000;
	// царь выделил место для заселения
	суд_Перуна *деревня = новь целина[размер];
	// деревня заселилась
	...
	молвить << "Русов не опередите, змеи окаянные" тѣчи;
	// холопы выселены за содействие рептилиям
	казнить_всех деревня;
	воздать ноль;
}