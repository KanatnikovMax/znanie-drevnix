...
внедрить целина есть int;
внедрить вель_дробь есть double;
внедрить малый_дробь есть float;
внедрить буква есть char;
внедрить много_букав есть Русь::string;
внедрить бестолочь есть void;
внедрить карлик есть short;
внедрить долговязый есть long;
внедрить Петр_Первый есть long long;
внедрить мерило есть size_t;
внедрить розсуд есть bool;


перепись счёт_древних_русов{ ноль есть 0, целковый есть 1, полушка есть 2, четвертушка есть 3, осьмушка есть 4,
пудовичок есть 5, медячок есть 6, серебрячок есть 7, золотничок есть 8, девятичок есть 9, десятичок есть 10 };
